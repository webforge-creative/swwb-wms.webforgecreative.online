...
class image_CRUD
{
	...
	function set_crud_base($crudbase)
	{
		$this->crud_base = $crudbase;

		return $this;
	}
	function crud_base($segments)
	{
		return $this->crud_base . "/" . $segments;
	}
	...
	protected function _get_delete_url($value)
	{
		...
		return $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/delete_file/' . $value);
	}
	...
	protected function getState()
	{
		...
		if (isset($rsegments_array[3]) && is_numeric($rsegments_array[3])) {
			$upload_url = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/upload_file/' . $rsegments_array[3]);
			$ajax_list_url  = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/' . $rsegments_array[3] . '/ajax_list');
			$ordering_url  = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/ordering');
			$insert_title_url  = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/insert_title');
			...
			$upload_url = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/upload_file');
			$ajax_list_url  = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/ajax_list');
			$ordering_url  = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/ordering');
			$insert_title_url  = $this->crud_base($rsegments_array[1] . '/' . $rsegments_array[2] . '/insert_title');
