...
$this->set_js($this->default_theme_path . '/test/js/cookies.js');
$this->set_js($this->default_theme_path . '/test/js/gogi.js');

$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.form.min.js');

$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.numeric.min.js');
$this->set_js($this->default_theme_path . '/test/js/jquery.printElement.min.js');
...
<div id='list-report-success' class='alert alert-success report-div success report-list'
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
    ...
    <div id='main-table-box' class="main-table-box">
        ...
        <div class="tDiv p-2" style="display:none !important;">
            <?php if (!$unset_add) {?>
            <div class="tDiv2 m-0 p-0">
                <a href="<?php echo $add_url ?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject ?>"
            ...
            <div class="tDiv3 btn-group">
                <?php if (!$unset_export) {?>
                <a href="<?php echo $export_url ?>" class="btn btn-secondary btn-sm" download>
                ...
                <?php }?>
                <?php if (!$unset_print) {?>
                <a data-url="<?php echo $print_url; ?>" class="print-anchor btn btn-secondary btn-sm text-white">
        ...
        <div class="d-flex justify-content-between sDiv quickSearchBox" id='quickSearchBox' style="display:none !important">
            <div class="sDiv2">
            ...
            <div class='search-div-clear-button'>
                <input type="button" value="<?php echo $this->l('list_clear_filtering'); ?>" id='search_clear'
                    class="btn btn-danger btn-sm search_clear">
            </div>
        </div>
        <div class="pDive" style="display:none !important">
            <div class="pDiv2">
                <div class="pGroup">
                    <span class="pcontrol">
                ...
                <div class="pGroup">
                    <span class="pcontrol">
                        <?php echo $this->l('list_page'); ?> <input name='page' type="text" value="1" size="4"
