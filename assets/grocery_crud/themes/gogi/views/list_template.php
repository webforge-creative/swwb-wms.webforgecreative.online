<?php
$this->set_css($this->default_theme_path . '/gogi/css/gogi.css');
...
$this->set_js($this->default_theme_path . '/gogi/js/cookies.js');
$this->set_js($this->default_theme_path . '/gogi/js/gogi.js');

$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.form.min.js');

$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.numeric.min.js');
$this->set_js($this->default_theme_path . '/gogi/js/jquery.printElement.min.js');
$this->set_js($this->default_theme_path . '/gogi/js/custom_js.js');
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div id='main-table-box' class="main-table-box">
			...
			<div class="tDiv p-2">
				<?php if (!$unset_add) { ?>
					<div class="tDiv2 m-0 p-0">
						<a href="<?php echo $add_url ?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject ?>" class="btn btn-flat btn-info btn-sm">
		...
		<div class="d-flex justify-content-between sDiv quickSearchBox" id='quickSearchBox'>
			<div class="sDiv2">
			...
			<div class='search-div-clear-button'>
				<input type="button" value="<?php echo $this->l('list_clear_filtering'); ?>" id='search_clear' class="btn btn-danger btn-sm search_clear">
			</div>
		</div>
		<div class="pDiv">
			<div class="pDiv2">
