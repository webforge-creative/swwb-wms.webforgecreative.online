...
$this->set_js_config($this->default_theme_path . '/gogi/js/gogi-add.js');
	...
	<div id='main-table-box'>
		...
		<div class="pDiv">
			...
			<?php if (!$this->unset_back_to_list) { ?>
				<div class='form-button-box'>
					<input type='button' value='<?php echo $this->l('form_save_and_go_back'); ?>' id="save-and-go-back-button" class="btn btn-primary btn-large" />
				</div>
				<div class='form-button-box'>
