...
$(function () {
	...
	$('.search_clear').click(function () {
		...
		eraseCookie('crud_page_' + unique_hash);
		eraseCookie('per_page_' + unique_hash);
		eraseCookie('hidden_ordering_' + unique_hash);
		eraseCookie('hidden_sorting_' + unique_hash);
		eraseCookie('search_text_' + unique_hash);
		eraseCookie('search_field_' + unique_hash); */
		$(this).closest('.flexigrid').find('#hidden-ordering').val('');
		$(this).closest('.flexigrid').find('#hidden-sorting').val('');
		$(this).closest('.flexigrid').find('#search_field').val('');
		$(this).closest('.flexigrid').find('.crud_page').val('1');
